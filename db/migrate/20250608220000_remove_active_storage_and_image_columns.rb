class RemoveActiveStorageAndImageColumns < ActiveRecord::Migration[7.0]
  def up
    # Remove image columns from posts
  ...
  def down
    # Recreate Active Storage tables (simplified version)
